...
const Modal = ({
  ...
  return (
    <>
      ...
      <dialog open={isOpen}>
        <div
          className="fixed left-0 top-0 z-[90] h-full w-full bg-[rgba(0,0,0,0.5)]"
          onClick={() => setIsOpen(false)}
        />
        <div
          className={`fixed left-1/2 top-1/2 z-[99] -translate-x-1/2 -translate-y-1/2 rounded-lg bg-white p-6 ${className}`}
        >
          <Button
